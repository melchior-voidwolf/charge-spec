    ...
    <div className="min-h-[calc(100vh-8rem)]">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          {/* Description */}
          {charger.description && (
            <p className="text-[14px] text-text-secondary max-w-3xl mt-4">
              {charger.description}
            </p>
          )}
        </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <ul className="space-y-1.5">
                  {charger.features.map((feature, index) => (
                    <li
                      key={index}
                      className="flex items-start text-text-secondary text-[13px]"
                    >
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center py-1.5 border-b border-gray-100">
                  ...
                  <span className={`font-medium text-[12px] ${charger.isGaN ? 'text-green-600' : 'text-text-tertiary'}`}>
                    {charger.isGaN ? '是' : '否'}
                  </span>
                </div>
                <div className="flex justify-between items-center py-1.5 border-b border-gray-100">
                  <span className="text-[12px] text-text-tertiary">折叠插脚</span>
                  <span className={`font-medium text-[12px] ${charger.hasFoldingPlug ? 'text-green-600' : 'text-text-tertiary'}`}>
            ...
            {charger.notes && (
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
                <h4 className="text-[12px] font-semibold text-amber-900 mb-1.5">
                  备注
                </h4>

          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {charger.power.configurations.map((config: any, index: number) => (
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {charger.protocols.map((protocol: string) => (
                  <span
                    key={protocol}
                    ...
                    {port.protocols && port.protocols.length > 0 && (
                      <div className="mt-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {port.protocols.map((protocol: string) => (
                            <span
                              key={protocol}
            ...
            {charger.features && charger.features.length > 0 && (
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <ul className="space-y-1.5">
                  {charger.features.map((feature: string, index: number) => (
            ...
            {charger.certifications && charger.certifications.length > 0 && (
              <div className="bg-white border border-gray-200 rounded-xl p-5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {charger.certifications.map((cert: string) => (
                    <span
                      key={cert}
                  ...
                  {charger.physicalSpecs.colors && charger.physicalSpecs.colors.length > 0 && (
                    <div className="py-1.5">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-1.5">
                        {charger.physicalSpecs.colors.map((color: string) => (
                          <span
                            key={color}
                            className="inline-block px-1.5 py-0.5 bg-sidebar text-text-secondary text-[10px] rounded"
                          >
